...
import Views.Main.InputText exposing (inputTextArea)
import Views.Main.Instructions exposing (viewInstructions)
import Views.Main.Registers exposing (viewRegisters)
