...
var $author$project$Main$AbacusMsg = function (a) {
	return {$: 'AbacusMsg', a: a};
};
var $author$project$Main$AbacusPage = {$: 'AbacusPage'};
var $author$project$Shared$Types$ConsoleMessage$InfoMessage = {$: 'InfoMessage'};
var $author$project$Main$Landing = {$: 'Landing'};
var $author$project$Main$RamMsg = function (a) {
	return {$: 'RamMsg', a: a};
};
var $author$project$Main$RamPage = {$: 'RamPage'};
...
var $author$project$Am$Utils$Init$init = function () {
	var initialModel = {
		...
		simStarted: false,
		simulationStartTime: $elm$core$Maybe$Nothing,
		slots: $elm$core$Array$fromList(
			_List_fromArray(
				[
					{inputText: '', name: ''},
					{inputText: '', name: 'Slot 1'},
					{inputText: '', name: 'Slot 2'},
					{inputText: '', name: 'Slot 3'},
					{inputText: '', name: 'Slot 4'},
					{inputText: '', name: 'Slot 5'},
					{inputText: '', name: 'Slot 6'},
					{inputText: '', name: 'Slot 7'},
					{inputText: '', name: 'Slot 8'},
					{inputText: '', name: 'Slot 9'},
					{inputText: '', name: 'Slot 10'},
					{inputText: '', name: 'Slot 11'},
					{inputText: '', name: 'Slot 12'},
					{inputText: '', name: 'Slot 13'},
					{inputText: '', name: 'Slot 14'},
					{inputText: '', name: 'Slot 15'},
					{inputText: '', name: 'Slot 16'},
					{inputText: '', name: 'Slot 17'},
					{inputText: '', name: 'Slot 18'},
					{inputText: '', name: 'Slot 19'},
					{inputText: '', name: 'Slot 20'},
...
var $author$project$Ram$Utils$Init$init = function () {
	var initialModel = {
		...
		executedInstructions: 0,
		halted: false,
		highlighted_input_tape: $elm$core$Dict$empty,
		highlighted_output_tape: $elm$core$Dict$empty,
		highlighted_registers: $elm$core$Dict$empty,
		inputTape: $elm$core$Array$empty,
		inputTapePointer: 0,
		inputText: '',
		instructionPointer: 0,
		instructions: _List_Nil,
		...
		logSpace: 0,
		logTime: 0,
		outputTape: $elm$core$Array$empty,
		registers: $elm$core$Dict$fromList(
			A2(
				$elm$core$List$map,
				function (n) {
		...
		slots: $elm$core$Array$fromList(
			_List_fromArray(
				[
					{inputTape: $elm$core$Array$empty, inputText: '', name: ''},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 1'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 2'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 3'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 4'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 5'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 6'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 7'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 8'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 9'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 10'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 11'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 12'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 13'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 14'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 15'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 16'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 17'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 18'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 19'},
					{inputTape: $elm$core$Array$empty, inputText: '', name: 'Slot 20'},
					{
					inputTape: $elm$core$Array$fromList(
						_List_fromArray(
							[48, 152])),
					inputText: '# Average of two numbers\n\n# Read numbers from input tape into R1 and R2\nread 1\nread 2\n\n# Add numbers into accumulator\nadd 1\nadd 2\n\n# Divide numbers by 2\ndiv =2\n\n# Write the result to the output tape\nwrite 0\n\nhalt',
					name: ''
				},
					{
					inputTape: $elm$core$Array$fromList(
...
var $author$project$Am$Types$Messages$AddMessageWithTime = F3(
	function (a, b, c) {
		return {$: 'AddMessageWithTime', a: a, b: b, c: c};
	});
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		var pageFromUrl = function () {
			...
			while (true) {
				if (_v1.$ === 'Just') {
					switch (_v1.a) {
						case 'abacus':
							return $author$project$Main$AbacusPage;
						case 'ram':
							return $author$project$Main$RamPage;
						default:
							break _v1$2;
					}
				} else {
		...
		var cmdToLoad = (_Utils_eq(pageFromUrl, $author$project$Main$AbacusPage) || _Utils_eq(pageFromUrl, $author$project$Main$RamPage)) ? $elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					$author$project$Am$Utils$HelperFunctions$requestAddMessage(
						_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$InfoMessage, 'Welcome to Abacus Machine Simulator'))),
					A2(
					$elm$core$Platform$Cmd$map,
					$author$project$Main$RamMsg,
					$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
						_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$InfoMessage, 'Welcome to RAM Simulator'))),
					$author$project$Shared$Ports$subToTextArea(_Utils_Tuple0)
				])) : $elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Shared$Ports$getItem('am_current'),
		...
		return _Utils_Tuple2(
			{abacusModel: $author$project$Am$Utils$Init$init, aboutModalOpen: false, key: key, page: pageFromUrl, ramModel: $author$project$Ram$Utils$Init$init},
			cmdToLoad);
	});
	...
	var ramSubs = function () {
		...
		if (_v1.$ === 'RamPage') {
			return A2(
				...
				$author$project$Main$RamMsg,
				$author$project$Main$ramSubscriptions(model.ramModel));
		} else {
			return $elm$core$Platform$Sub$none;
		}
	}();
	var abacusSubs = function () {
		...
		if (_v0.$ === 'AbacusPage') {
			return A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$AbacusMsg,
				$author$project$Main$abacusSubscriptions(model.abacusModel));
		} else {
			return $elm$core$Platform$Sub$none;
		}
	}();
...
var $author$project$Main$DelayedSubToTextArea = {$: 'DelayedSubToTextArea'};
var $author$project$Am$Types$Slot$Slot = F2(
	function (name, inputText) {
		return {inputText: inputText, name: name};
	});
...
var $author$project$Ram$Types$Slot$Slot = F3(
	function (name, inputText, inputTape) {
		return {inputTape: inputTape, inputText: inputText, name: name};
	});
...
var $author$project$Am$Types$Instructions$Decrement = F2(
	function (a, b) {
		return {$: 'Decrement', a: a, b: b};
	});
var $author$project$Am$Types$Instructions$EndLoop = F3(
	function (a, b, c) {
		return {$: 'EndLoop', a: a, b: b, c: c};
	});
var $author$project$Am$Types$Instructions$Increment = F2(
	function (a, b) {
		return {$: 'Increment', a: a, b: b};
	});
var $author$project$Am$Types$ErrorType$ReferencingNonExistingReg = {$: 'ReferencingNonExistingReg'};
var $author$project$Am$Types$Instructions$StartLoop = F3(
	function (a, b, c) {
		return {$: 'StartLoop', a: a, b: b, c: c};
	});
var $author$project$Am$Types$Instructions$UnknownInstruction = {$: 'UnknownInstruction'};
var $author$project$Am$Types$ErrorType$UnmatchedEndLoop = {$: 'UnmatchedEndLoop'};
var $author$project$Am$Types$ErrorType$UnmatchedStartLoop = {$: 'UnmatchedStartLoop'};
				...
				if (!input.b) {
						...
						function (instr) {
							if (instr.$ === 'StartLoop') {
								...
								return (_Utils_eq(endLoopIndex, -1) && _Utils_eq(conditionIndex, -1)) ? A3(
									...
									currentIndex,
									currentIndex,
									$elm$core$Maybe$Just($author$project$Am$Types$ErrorType$UnmatchedStartLoop)) : instr;
							} else {
								var other = instr;
								return other;
							}
					...
					switch (input.a.valueOf()) {
						case 'a':
							...
							if (A2($elm$core$Dict$member, value, model.registers)) {
								...
								var $temp$input = remaining,
									...
									_List_fromArray(
										[
											...
											value,
											$elm$core$Maybe$Just($author$project$Am$Types$ErrorType$ReferencingNonExistingReg))
										])),
									$temp$stack = stack,
									$temp$currentIndex = currentIndex + 1,
									$temp$parsingComment = false,
						...
						case ')':
							...
							var conditionIndex = A2(
								...
								$elm$core$String$toInt(
									$elm$core$String$fromList(digits)));
							if (!A2($elm$core$Dict$member, conditionIndex, model.registers)) {
								var $temp$input = remaining,
									$temp$instructions = _Utils_ap(
									instructions,
									_List_fromArray(
									...
									var $temp$input = remaining,
										...
										_List_fromArray(
											[
												...
												-1,
												conditionIndex,
												$elm$core$Maybe$Just($author$project$Am$Types$ErrorType$UnmatchedEndLoop))
											])),
										$temp$stack = stack,
										$temp$currentIndex = currentIndex + 1,
										$temp$parsingComment = false,
...
var $author$project$Ram$Types$ErrorType$DivByZero = {$: 'DivByZero'};
var $author$project$Ram$Types$ErrorType$DuplicatedLabel = {$: 'DuplicatedLabel'};
var $author$project$Ram$Types$Instructions$Halt = function (a) {
	return {$: 'Halt', a: a};
};
var $author$project$Ram$Types$ErrorType$InvalidInstruction = {$: 'InvalidInstruction'};
...
var $author$project$Ram$Types$Instructions$Read = F3(
	function (a, b, c) {
		return {$: 'Read', a: a, b: b, c: c};
	});
var $author$project$Ram$Types$ErrorType$ReferencingNonExistingReg = {$: 'ReferencingNonExistingReg'};
...
var $author$project$Ram$Types$Instructions$UnknownInstruction = {$: 'UnknownInstruction'};
var $author$project$Ram$Types$Instructions$Write = F3(
	function (a, b, c) {
		return {$: 'Write', a: a, b: b, c: c};
	});
...
var $author$project$Ram$Types$Instructions$Jgtz = F4(
	function (a, b, c, d) {
		return {$: 'Jgtz', a: a, b: b, c: c, d: d};
	});
var $author$project$Ram$Types$Instructions$Jump = F4(
	function (a, b, c, d) {
		return {$: 'Jump', a: a, b: b, c: c, d: d};
	});
var $author$project$Ram$Types$Instructions$Jzero = F4(
	function (a, b, c, d) {
		return {$: 'Jzero', a: a, b: b, c: c, d: d};
	});
var $author$project$Ram$Types$ErrorType$ReferencingNonExistingLabel = {$: 'ReferencingNonExistingLabel'};
			...
			switch (instruction) {
				case 'Jump':
					return A4(
						...
						0,
						labelName,
						$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$ReferencingNonExistingLabel),
						0);
				case 'Jzero':
					return A4(
			...
			if (!parts.b.b) {
				...
				if (_v1 === 'HALT') {
					...
					return A2($elm$core$String$endsWith, ':', something) ? (($elm$core$String$length(something) > 1) ? (_Utils_eq(
						...
						$author$project$Ram$Types$Instructions$Label,
						A2($elm$core$String$dropRight, 1, something),
						$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$DuplicatedLabel))) : $author$project$Ram$Types$Instructions$UnknownInstruction) : $author$project$Ram$Types$Instructions$UnknownInstruction;
				}
			} else {
							...
							switch (_v6) {
								case 'LOAD':
									switch (operand.$) {
										...
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Load, operand, $elm$core$Maybe$Nothing, 0) : A3(
												$author$project$Ram$Types$Instructions$Load,
												operand,
												$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$ReferencingNonExistingReg),
												0);
										default:
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Load, operand, $elm$core$Maybe$Nothing, 0) : A3(
									...
									switch (operand.$) {
										case 'Constant':
											return A3(
												...
												operand,
												$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$InvalidInstruction),
												0);
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Store, operand, $elm$core$Maybe$Nothing, 0) : A3(
												$author$project$Ram$Types$Instructions$Store,
												operand,
												$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$ReferencingNonExistingReg),
												0);
								...
								case 'ADD':
									switch (operand.$) {
										...
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Add, operand, $elm$core$Maybe$Nothing, 0) : A3(
								...
								case 'SUB':
									switch (operand.$) {
										...
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Sub, operand, $elm$core$Maybe$Nothing, 0) : A3(
								...
								case 'MUL':
									switch (operand.$) {
										...
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Mul, operand, $elm$core$Maybe$Nothing, 0) : A3(
									...
									switch (operand.$) {
										case 'Constant':
											...
											return (!value) ? A3(
												...
												operand,
												$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$DivByZero),
												0) : A3($author$project$Ram$Types$Instructions$Div, operand, $elm$core$Maybe$Nothing, 0);
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Div, operand, $elm$core$Maybe$Nothing, 0) : A3(
												$author$project$Ram$Types$Instructions$Div,
												operand,
												$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$ReferencingNonExistingReg),
												0);
								...
								case 'READ':
									switch (operand.$) {
										...
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Read, operand, $elm$core$Maybe$Nothing, 0) : A3(
												$author$project$Ram$Types$Instructions$Read,
												operand,
												$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$ReferencingNonExistingReg),
												0);
								...
								case 'WRITE':
									switch (operand.$) {
										...
										case 'Direct':
											var n = operand.a;
											return A2($elm$core$Dict$member, n, model.registers) ? A3($author$project$Ram$Types$Instructions$Write, operand, $elm$core$Maybe$Nothing, 0) : A3(
												$author$project$Ram$Types$Instructions$Write,
												operand,
												$elm$core$Maybe$Just($author$project$Ram$Types$ErrorType$ReferencingNonExistingReg),
												0);
...
var $author$project$Am$Types$Messages$ComputeAndPrintDuration = function (a) {
	return {$: 'ComputeAndPrintDuration', a: a};
};
var $author$project$Am$Types$Messages$SetStartTime = function (a) {
	return {$: 'SetStartTime', a: a};
};
var $author$project$Shared$Types$ConsoleMessage$SimStarted = {$: 'SimStarted'};
var $author$project$Shared$Types$ConsoleMessage$SimStopped = {$: 'SimStopped'};
var $author$project$Am$Types$Messages$StartInstantSimulation = function (a) {
	return {$: 'StartInstantSimulation', a: a};
};
var $author$project$Shared$Types$ConsoleMessage$Warning = {$: 'Warning'};
		...
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'name',
					$elm$json$Json$Encode$string(slot.name)),
					_Utils_Tuple2(
					'inputText',
					$elm$json$Json$Encode$string(slot.inputText))
				])));
};
...
var $author$project$Am$Utils$ExecuteInstruction$executeInstruction = F2(
	function (model, highlightDuration) {
		...
		var currentInstruction = $elm$core$List$head(
			A2($elm$core$List$drop, model.instructionPointer, model.instructions));
		if (currentInstruction.$ === 'Nothing') {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{isRunning: false}),
			...
			var dontHighlight = ((model.speedIdx === 7) || (model.speedIdx === 6)) && model.isRunning;
			switch (instr.$) {
				case 'Increment':
					var reg = instr.a;
					var isError = instr.b;
					if (isError.$ === 'Just') {
						...
						if (dontHighlight) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{executedInstructions: model.executedInstructions + 1, instructionPointer: nextInstructionPointer, registers: newRegisters}),
								$elm$core$Platform$Cmd$none);
						} else {
							var updatedModel = _Utils_update(
								model,
								{
									...
									highlighted: A3($elm$core$Dict$insert, reg, 'bg-green-200', $elm$core$Dict$empty),
									instructionPointer: nextInstructionPointer,
					...
					if (isError.$ === 'Just') {
						...
						if (dontHighlight) {
							...
							var updatedModel = _Utils_update(
								...
								{
									executedInstructions: model.executedInstructions + 1,
									highlighted: A3($elm$core$Dict$insert, reg, 'bg-yellow-200', $elm$core$Dict$empty),
									instructionPointer: nextInstructionPointer,
									registers: newRegisters
								});
							return _Utils_Tuple2(
					...
					if (isError.$ === 'Just') {
						...
						var conditionValue = A2(
							...
							A2(
								...
								A2($elm$core$Dict$get, conditionIndex, model.registers)));
						return (!conditionValue) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{executedInstructions: model.executedInstructions + 1, instructionPointer: endLoopIndex}),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							_Utils_update(
								model,
								{executedInstructions: model.executedInstructions + 1, instructionPointer: nextInstructionPointer}),
							$elm$core$Platform$Cmd$none);
					}
				case 'EndLoop':
					...
					if (isError.$ === 'Just') {
						...
						return (!conditionValue) ? _Utils_Tuple2(
							...
							_Utils_update(
								model,
								{executedInstructions: model.executedInstructions + 1, instructionPointer: startLoopIndex}),
							$elm$core$Platform$Cmd$none);
					}
				default:
					return _Utils_Tuple2(
...
var $author$project$Shared$Types$ConsoleMessage$ErrorMessage = {$: 'ErrorMessage'};
...
var $author$project$Am$Utils$PrintErrors$checkForNonExistingRegisters = function (instructions) {
			...
			F2(
				function (i, instr) {
					switch (instr.$) {
						case 'Increment':
							var isError = instr.b;
							if ((isError.$ === 'Just') && (isError.a.$ === 'ReferencingNonExistingReg')) {
								var _v2 = isError.a;
	...
	return (nERECount === 1) ? $elm$core$Maybe$Just(
		$author$project$Am$Utils$HelperFunctions$requestAddMessage(
			_Utils_Tuple2(
				$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
		...
		A2(
			...
			F2(
				function (i, instr) {
					if (instr.$ === 'EndLoop') {
						var isError = instr.c;
						if ((isError.$ === 'Just') && (isError.a.$ === 'UnmatchedEndLoop')) {
							var _v2 = isError.a;
							return $elm$core$Maybe$Just(i + 1);
						} else {
							return $elm$core$Maybe$Nothing;
		...
		A2(
			...
			F2(
				function (i, instr) {
					if (instr.$ === 'StartLoop') {
						var isError = instr.c;
						if ((isError.$ === 'Just') && (isError.a.$ === 'UnmatchedStartLoop')) {
							var _v2 = isError.a;
							return $elm$core$Maybe$Just(i + 1);
						} else {
							return $elm$core$Maybe$Nothing;
...
var $author$project$Am$Utils$ExecuteInstruction$runAllInstructions = function (model) {
	runAllInstructions:
	while (true) {
		if (_Utils_cmp(model.executedInstructions, model.totalMaxExecutedInstructions) > -1) {
			return model;
		} else {
			if (_Utils_cmp(
				model.instructionPointer,
				$elm$core$List$length(model.instructions)) > -1) {
				return model;
			} else {
		...
		switch (msg.$) {
			...
			case 'Tick':
				if (!model.isRunning) {
					...
					return (_Utils_cmp(
						updatedModel.instructionPointer,
						$elm$core$List$length(updatedModel.instructions)) > -1) ? _Utils_Tuple2(
						_Utils_update(
							updatedModel,
							{isRunning: false}),
						$elm$core$Platform$Cmd$batch(
			...
			case 'Step':
				...
				return ((!model.simStarted) && (_Utils_cmp(
					newModel.instructionPointer,
					$elm$core$List$length(newModel.instructions)) > -1)) ? _Utils_Tuple2(
					_Utils_update(
						newModel,
						{simStarted: true}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Am$Utils$PrintErrors$printErrors(model.instructions),
								removeHighlightCmd,
								$author$project$Am$Utils$HelperFunctions$requestAddMessage(
								_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$SimStarted, 'Simulation started')),
								A2($elm$core$Task$perform, $author$project$Am$Types$Messages$ComputeAndPrintDuration, $elm$time$Time$now),
								A2($elm$core$Task$perform, $author$project$Am$Types$Messages$SetStartTime, $elm$time$Time$now)
							]))) : ((!model.simStarted) ? _Utils_Tuple2(
					_Utils_update(
						newModel,
						{simStarted: true}),
					$elm$core$Platform$Cmd$batch(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								removeHighlightCmd,
								A2($elm$core$Task$perform, $author$project$Am$Types$Messages$ComputeAndPrintDuration, $elm$time$Time$now)
							]))) : (model.simStarted ? _Utils_Tuple2(newModel, removeHighlightCmd) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none))));
			case 'Start':
				if ((model.speedIdx === 7) && (!model.simStarted)) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
					...
					if ((model.speedIdx === 7) && model.simStarted) {
						var finalModel = $author$project$Am$Utils$ExecuteInstruction$runAllInstructions(
							_Utils_update(
								model,
								{isRunning: true}));
						return (_Utils_cmp(finalModel.executedInstructions, model.totalMaxExecutedInstructions) > -1) ? _Utils_Tuple2(
							_Utils_update(
								finalModel,
								{isRunning: false}),
							$author$project$Am$Utils$HelperFunctions$requestAddMessage(
								_Utils_Tuple2(
									$author$project$Shared$Types$ConsoleMessage$Warning,
									'Warning: Maximum number of instant-speed instructions exceeded (' + ($elm$core$String$fromInt(finalModel.executedInstructions) + '). Your code may contain an infinite loop or be too complex. You can change this limit in settings, or continue with slower speed or step mode to debug.')))) : _Utils_Tuple2(
							finalModel,
							A2($elm$core$Task$perform, $author$project$Am$Types$Messages$ComputeAndPrintDuration, $elm$time$Time$now));
					} else {
						if (model.simStarted) {
			...
			case 'StartInstantSimulation':
				var now = msg.a;
				var updatedModel = _Utils_update(
					model,
					{
						simulationStartTime: $elm$core$Maybe$Just(now)
					});
			...
			case 'SetStartTime':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ComputeAndPrintDuration':
				var now = msg.a;
				var _v3 = model.simulationStartTime;
				if (_v3.$ === 'Just') {
					var startTime = _v3.a;
					var numOfInstructions = model.executedInstructions;
					...
					return (!numOfInstructions) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{executedInstructions: 0, isRunning: false, simulationStartTime: $elm$core$Maybe$Nothing}),
						$author$project$Am$Utils$HelperFunctions$requestAddMessage(
							_Utils_Tuple2(
								$author$project$Shared$Types$ConsoleMessage$InfoMessage,
			...
			case 'Pause':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{highlighted: $elm$core$Dict$empty, isRunning: false}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							registers: $elm$core$Dict$fromList(
								A2(
									...
									A2($elm$core$List$range, 0, model.totalNumberOfRegisters))),
							simStarted: false,
							simulationStartTime: $elm$core$Maybe$Nothing
						}),
					$author$project$Am$Utils$HelperFunctions$requestAddMessage(
						_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$SimStopped, 'Simulation stopped')));
			case 'ChangeSpeed':
				var newSpeed = msg.a;
				if ((newSpeed === 7) && model.isRunning) {
					var finalModel = $author$project$Am$Utils$ExecuteInstruction$runAllInstructions(
						_Utils_update(
							model,
							{isRunning: true, speedIdx: newSpeed}));
					return (_Utils_cmp(finalModel.executedInstructions, model.totalMaxExecutedInstructions) > -1) ? _Utils_Tuple2(
						_Utils_update(
							finalModel,
							{isRunning: false}),
			...
			case 'AddMessageWithTime':
				...
				var posix = msg.b;
				var text = msg.c;
				var newConsoleMessage = {messageType: messageType, text: text, timestamp: posix};
				var updatedModel = _Utils_update(
					model,
					{
			...
			case 'SaveSlot':
				var i = msg.a;
				var _v4 = A2($elm$core$Array$get, i, model.slots);
				if (_v4.$ === 'Just') {
					var slot = _v4.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								slots: A3($elm$core$Array$set, i, updatedSlot, model.slots)
							}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
			...
			case 'DeleteSlot':
				var i = msg.a;
				var _v5 = A2($elm$core$Array$get, i, model.slots);
				if (_v5.$ === 'Just') {
					var slot = _v5.a;
					var updatedSlot = _Utils_update(
						slot,
			...
			case 'LoadSlot':
				var i = msg.a;
				var _v6 = A2($elm$core$Array$get, i, model.slots);
				if (_v6.$ === 'Just') {
					var slot = _v6.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								instructionPointer: 0,
								instructions: A2($author$project$Am$Utils$AbacusParser$parseAM, slot.inputText, model),
								isRunning: false,
								registers: $elm$core$Dict$fromList(
									A2(
										$elm$core$List$map,
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
										'am_current',
										$author$project$Am$Utils$HelperFunctions$encodeSlot(
											{inputText: slot.inputText, name: ''}))),
									$author$project$Am$Utils$HelperFunctions$requestAddMessage(
									_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$InfoMessage, 'Example 1 loaded.'))
								...
								[
									...
									_Utils_Tuple2(
										...
										$author$project$Am$Utils$HelperFunctions$encodeSlot(
											{inputText: slot.inputText, name: ''}))),
									$author$project$Am$Utils$HelperFunctions$requestAddMessage(
									_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$InfoMessage, 'Example 2 loaded.'))
								...
								[
									...
									_Utils_Tuple2(
										...
										$author$project$Am$Utils$HelperFunctions$encodeSlot(
											{inputText: slot.inputText, name: ''}))),
									$author$project$Am$Utils$HelperFunctions$requestAddMessage(
									_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$InfoMessage, 'Example 3 loaded.'))
								])) : $elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									$author$project$Shared$Ports$setItem(
			...
			case 'UpdateSlotName':
				var i = msg.a;
				var newName = msg.b;
				var _v7 = A2($elm$core$Array$get, i, model.slots);
				if (_v7.$ === 'Just') {
					var slot = _v7.a;
					var updatedSlot = _Utils_update(
						slot,
			...
			case 'ToggleSlotsModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showSlotsModal: !model.showSlotsModal}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleGuideModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showGuideModal: !model.showGuideModal}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleSettingsModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showSettingsModal: !model.showSettingsModal}),
					$elm$core$Platform$Cmd$none);
			case 'GoBackToMenu':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'ChangeNumOfRegisters':
				var newNum = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							totalNumberOfRegisters: newNum
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeMaxExecutedInstructions':
				var newNum = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{totalMaxExecutedInstructions: newNum}),
					$elm$core$Platform$Cmd$none);
			case 'TypedRegsNum':
				var newText = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{typedTotalNumberOfRegisters: newText}),
					$elm$core$Platform$Cmd$none);
			case 'TypedMaxExecutedInstructions':
				var newText = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{typedTotalMaxExecutedInstructions: newText}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
...
var $author$project$Ram$Types$Messages$ComputeAndPrintDuration = F2(
	function (a, b) {
		return {$: 'ComputeAndPrintDuration', a: a, b: b};
	});
var $author$project$Ram$Types$Messages$RequestMathJaxUpdate = {$: 'RequestMathJaxUpdate'};
...
var $author$project$Ram$Utils$ExecuteInstruction$getRegisterValue = F2(
	function (regIndex, model) {
		return A2(
			$elm$core$Maybe$map,
			$elm$core$Tuple$first,
			A2($elm$core$Dict$get, regIndex, model.registers));
	});
				...
				case 'Load':
					...
					if (isError.$ === 'Just') {
						...
						switch (operand.$) {
							case 'Constant':
								var n = operand.a;
								var newLogTime = model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, n);
								var _v4 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, n, model.logBase, model.registers);
								...
								return dontHighlight ? _Utils_Tuple2(
									...
									_Utils_update(
										...
										{
											executedInstructions: model.executedInstructions + 1,
											highlighted_registers: A3($elm$core$Dict$insert, 0, 'bg-blue-200', $elm$core$Dict$empty),
											instructionPointer: nextInstructionPointer,
											instructions: A3(
												updateInstructionAt,
												model.instructionPointer,
							...
							case 'Direct':
								...
								if (maybeValue.$ === 'Nothing') {
									...
									var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
									var _v7 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, value, model.logBase, model.registers);
									...
									if (dontHighlight) {
										...
										var updatedModel = _Utils_update(
											...
											{
												executedInstructions: model.executedInstructions + 1,
												highlighted_registers: A3($elm$core$Dict$insert, regIndex, 'bg-blue-200', $elm$core$Dict$empty),
												instructionPointer: nextInstructionPointer,
												instructions: A3(
													updateInstructionAt,
													model.instructionPointer,
									...
									if (maybeValue.$ === 'Nothing') {
												...
												model,
												{
													...
													instructions: A3(
														...
														A3(
															...
															exeCount + 1),
														model.instructions),
													logTime: ((model.logTime + A2(
														$author$project$Ram$Utils$ExecuteInstruction$calculateLogTime,
														model.logBase,
														A2($elm$core$Maybe$withDefault, 0, maybeValue))) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)
												}),
											$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
												_Utils_Tuple2(
													$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
													'Runtime Error: Instruction ' + ($elm$core$String$fromInt(model.instructionPointer + 1) + ' attempted to access a non-existent register.'))));
									} else {
										var value = maybeValue.a;
										var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
										var _v12 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, value, model.logBase, model.registers);
										...
										if (dontHighlight) {
											...
											var updatedModel = _Utils_update(
												...
												{
													executedInstructions: model.executedInstructions + 1,
													highlighted_registers: A3($elm$core$Dict$insert, pointer, 'bg-blue-200', $elm$core$Dict$empty),
													instructionPointer: nextInstructionPointer,
													instructions: A3(
														updateInstructionAt,
														model.instructionPointer,
						...
						switch (operand.$) {
							...
							case 'Direct':
								...
								if (maybeAccVal.$ === 'Nothing') {
									...
									var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
									var _v18 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, regIndex, accVal, model.logBase, model.registers);
							...
							default:
								...
								if (maybePointer.$ === 'Nothing') {
									...
									if (maybeValue.$ === 'Nothing') {
												...
												model,
												{
													...
													instructions: A3(
														...
														A3(
															...
															exeCount + 1),
														model.instructions),
													logTime: ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)
												}),
											$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
												_Utils_Tuple2(
													$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
										...
										var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
										var _v23 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, pointer, accVal, model.logBase, model.registers);
						...
						switch (operand.$) {
							case 'Constant':
								...
								var accVal = A2(
									...
									0,
									A2($author$project$Ram$Utils$ExecuteInstruction$getRegisterValue, 0, model));
								var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value);
								var _v28 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal + value, model.logBase, model.registers);
							...
							case 'Direct':
								...
								if (maybeValue.$ === 'Nothing') {
									...
									var value = maybeValue.a;
									var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
									var _v31 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal + value, model.logBase, model.registers);
							...
							default:
								...
								if (maybePointer.$ === 'Nothing') {
									...
									if (maybeValue.$ === 'Nothing') {
												...
												model,
												{
													...
													instructions: A3(
														...
														A3(
															...
															exeCount + 1),
														model.instructions),
													logTime: (((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2(
														$author$project$Ram$Utils$ExecuteInstruction$calculateLogTime,
														model.logBase,
														A2($elm$core$Maybe$withDefault, 0, maybeValue))) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)
												}),
										...
										var value = maybeValue.a;
										var newLogTime = (((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
										var _v36 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal + value, model.logBase, model.registers);
						...
						switch (operand.$) {
							case 'Constant':
								...
								var accVal = A2(
									...
									A2($author$project$Ram$Utils$ExecuteInstruction$getRegisterValue, 0, model));
								var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value);
								var _v41 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal - value, model.logBase, model.registers);
							...
							case 'Direct':
								...
								if (maybeValue.$ === 'Nothing') {
									...
									var value = maybeValue.a;
									var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
									var _v44 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal - value, model.logBase, model.registers);
							...
							default:
								...
								if (maybePointer.$ === 'Nothing') {
									...
									if (maybeValue.$ === 'Nothing') {
										...
										var value = maybeValue.a;
										var newLogTime = (((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
										var _v49 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal - value, model.logBase, model.registers);
						...
						switch (operand.$) {
							case 'Constant':
								...
								var accVal = A2(
									...
									A2($author$project$Ram$Utils$ExecuteInstruction$getRegisterValue, 0, model));
								var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value);
								var _v54 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal * value, model.logBase, model.registers);
							...
							case 'Direct':
								...
								if (maybeValue.$ === 'Nothing') {
									...
									var value = maybeValue.a;
									var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
									var _v57 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal * value, model.logBase, model.registers);
							...
							default:
								...
								if (maybePointer.$ === 'Nothing') {
									...
									if (maybeValue.$ === 'Nothing') {
										...
										var value = maybeValue.a;
										var newLogTime = (((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
										var _v62 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, accVal * value, model.logBase, model.registers);
						...
						switch (operand.$) {
							case 'Constant':
								...
								var accVal = A2(
									...
									A2($author$project$Ram$Utils$ExecuteInstruction$getRegisterValue, 0, model));
								var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value);
								var _v67 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, (accVal / value) | 0, model.logBase, model.registers);
							...
							case 'Direct':
								...
								if (maybeValue.$ === 'Nothing') {
									...
									var value = maybeValue.a;
									var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
									var _v70 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, (accVal / value) | 0, model.logBase, model.registers);
										...
										if (dontHighlight && (!value)) {
											return _Utils_Tuple2(
												...
												$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
													_Utils_Tuple2(
														$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
														'Runtime Error: Instruction ' + ($elm$core$String$fromInt(model.instructionPointer + 1) + ' attempted to divide by zero.'))));
										} else {
											var updatedModel = (!(!value)) ? _Utils_update(
												...
												{
													executedInstructions: model.executedInstructions + 1,
													highlighted_registers: A3($elm$core$Dict$insert, regIndex, 'bg-red-200', $elm$core$Dict$empty),
													instructionPointer: nextInstructionPointer,
													instructions: A3(
														updateInstructionAt,
														model.instructionPointer,
							...
							default:
								...
								if (maybePointer.$ === 'Nothing') {
									...
									if (maybeValue.$ === 'Nothing') {
												...
												model,
												{
													...
													instructions: A3(
														...
														A3(
															...
															exeCount + 1),
														model.instructions),
													logTime: (((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, 0)
												}),
											$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
												_Utils_Tuple2(
													$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
										...
										var value = maybeValue.a;
										var newLogTime = (((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex);
										var _v76 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, 0, (accVal / value) | 0, model.logBase, model.registers);
										...
										if (dontHighlight && (!(!value))) {
											...
											if (dontHighlight && (!value)) {
												...
												var updatedModel = (!(!value)) ? _Utils_update(
													...
													{
														executedInstructions: model.executedInstructions + 1,
														highlighted_registers: A3($elm$core$Dict$insert, pointer, 'bg-red-200', $elm$core$Dict$empty),
														instructionPointer: nextInstructionPointer,
														instructions: A3(
															updateInstructionAt,
															model.instructionPointer,
				...
				case 'Jzero':
					...
					if (isError.$ === 'Just') {
						...
						var accVal = A2(
							...
							0,
							A2($author$project$Ram$Utils$ExecuteInstruction$getRegisterValue, 0, model));
						var newLogTime = model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, accVal);
				...
				case 'Read':
					...
					if (isError.$ === 'Just') {
						...
						switch (operand.$) {
							...
							case 'Direct':
								var regIndex = operand.a;
								var _v85 = A2($elm$core$Array$get, model.inputTapePointer, model.inputTape);
								if (_v85.$ === 'Nothing') {
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												...
												instructions: A3(
													...
													A3(
														...
														exeCount + 1),
													model.instructions),
												logTime: (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, 0)
											}),
										$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
											_Utils_Tuple2(
												$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
												'Runtime Error: Instruction ' + ($elm$core$String$fromInt(model.instructionPointer + 1) + ' attempted to read from the input tape, while no more values are available.'))));
								} else {
									var val = _v85.a;
									var maybePointer = A2($author$project$Ram$Utils$ExecuteInstruction$getRegisterValue, regIndex, model);
									if (maybePointer.$ === 'Nothing') {
										...
										var newTapePointer = model.inputTapePointer + 1;
										var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, val);
										var _v87 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, regIndex, val, model.logBase, model.registers);
										...
										if (dontHighlight) {
											...
											var updatedModel = _Utils_update(
												...
												{
													executedInstructions: model.executedInstructions + 1,
													highlighted_input_tape: A3($elm$core$Dict$insert, model.inputTapePointer, 'bg-blue-200', $elm$core$Dict$empty),
													inputTapePointer: newTapePointer,
													instructionPointer: nextInstructionPointer,
													instructions: A3(
														updateInstructionAt,
											...
											var switchHighlightCmd = A2(
												...
												function (_v89) {
													return A2(
														$author$project$Ram$Types$Messages$SwitchHighlight,
														_Utils_Tuple2(0, model.inputTapePointer),
														_Utils_Tuple3(1, regIndex, 'bg-blue-200'));
												},
												$elm$core$Process$sleep((highlightDuration / 2) | 0));
											var removeHighlightCmd = A2(
							...
							default:
								var regIndex = operand.a;
								var _v90 = A2($elm$core$Array$get, model.inputTapePointer, model.inputTape);
								if (_v90.$ === 'Nothing') {
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												...
												instructions: A3(
													...
													A3(
														...
														exeCount + 1),
													model.instructions),
												logTime: ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, 0)) + A2(
													$author$project$Ram$Utils$ExecuteInstruction$calculateLogTime,
													model.logBase,
													A2(
														$elm$core$Maybe$withDefault,
									...
									if (maybePointer.$ === 'Nothing') {
										...
										if (maybeValue.$ === 'Nothing') {
													...
													model,
													{
														...
														instructions: A3(
															...
															A3(
																...
																exeCount + 1),
															model.instructions),
														logTime: ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, valueToRead)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)
													}),
												$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
													_Utils_Tuple2(
														$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
											...
											var newTapePointer = model.inputTapePointer + 1;
											var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, valueToRead)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer);
											var _v93 = A4($author$project$Ram$Utils$ExecuteInstruction$updateRegisterAndComputeLogSpace, pointer, valueToRead, model.logBase, model.registers);
						...
						switch (operand.$) {
							...
							case 'Direct':
								...
								if (maybeValue.$ === 'Nothing') {
									...
									var value = maybeValue.a;
									var updatedOutputTape = A2($elm$core$Array$push, value, model.outputTape);
									var newLogTime = (model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value);
									if (dontHighlight) {
										return _Utils_Tuple2(
											_Utils_update(
												model,
							...
							default:
								...
								if (maybePointer.$ === 'Nothing') {
									...
									if (maybeValue.$ === 'Nothing') {
												...
												model,
												{
													...
													instructions: A3(
														...
														A3(
															...
															exeCount + 1),
														model.instructions),
													logTime: ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, 0)
												}),
											$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
												_Utils_Tuple2(
													$author$project$Shared$Types$ConsoleMessage$ErrorMessage,
										...
										var value = maybeValue.a;
										var updatedOutputTape = A2($elm$core$Array$push, value, model.outputTape);
										var newLogTime = ((model.logTime + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, regIndex)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, pointer)) + A2($author$project$Ram$Utils$ExecuteInstruction$calculateLogTime, model.logBase, value);
										if (dontHighlight) {
											return _Utils_Tuple2(
												_Utils_update(
													model,
		...
		A2(
			...
			F2(
				function (i, instr) {
					if (instr.$ === 'Div') {
						var isError = instr.b;
						if ((isError.$ === 'Just') && (isError.a.$ === 'DivByZero')) {
							var _v2 = isError.a;
							return $elm$core$Maybe$Just(i + 1);
						} else {
							return $elm$core$Maybe$Nothing;
		...
		A2(
			...
			F2(
				function (i, instr) {
					if (instr.$ === 'Label') {
						var isError = instr.b;
						if ((isError.$ === 'Just') && (isError.a.$ === 'DuplicatedLabel')) {
							var _v2 = isError.a;
							return $elm$core$Maybe$Just(i + 1);
						} else {
							return $elm$core$Maybe$Nothing;
			...
			F2(
				function (i, instr) {
					switch (instr.$) {
						case 'Store':
							var isError = instr.b;
							if ((isError.$ === 'Just') && (isError.a.$ === 'InvalidInstruction')) {
								var _v2 = isError.a;
								return $elm$core$Maybe$Just(i + 1);
							} else {
								return $elm$core$Maybe$Nothing;
			...
			F2(
				function (i, instr) {
					switch (instr.$) {
						case 'Jump':
							var isError = instr.c;
							if ((isError.$ === 'Just') && (isError.a.$ === 'ReferencingNonExistingLabel')) {
								var _v2 = isError.a;
								return $elm$core$Maybe$Just(i + 1);
							} else {
								return $elm$core$Maybe$Nothing;
...
var $author$project$Ram$Utils$ExecuteInstruction$runAllInstructions = function (_v0) {
	...
	while (true) {
		...
		if (_Utils_cmp(model.executedInstructions, model.totalMaxExecutedInstructions) > -1) {
			...
			if ((_Utils_cmp(
				model.instructionPointer,
				$elm$core$List$length(model.instructions)) > -1) || model.halted) {
				return _Utils_Tuple3(model, someCmd, numOfMsgs);
			} else {
				if (numOfMsgs >= 100) {
					return _Utils_Tuple3(
		...
		switch (msg.$) {
			case 'UpdateCode':
				...
				var encodedSlot = $author$project$Ram$Utils$HelperFunctions$encodeSlot(
					{inputTape: model.inputTape, inputText: newCode, name: ''});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{inputText: newCode, instructions: newInstructions}),
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								$author$project$Ram$Utils$PrintErrors$printErrors(model.instructions),
								$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
								_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$SimStarted, 'Simulation started'))
							]))) : ((!model.simStarted) ? _Utils_Tuple2(
					_Utils_update(
							...
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
											$author$project$Shared$Types$ConsoleMessage$Warning,
											'Warning: Maximum number of instant-speed instructions exceeded (' + ($elm$core$String$fromInt(finalModel.executedInstructions) + '). Your code may contain an infinite loop or be too complex. You can change this limit in settings, or continue with slower speed or step mode to debug.'))),
										someCmds
									]))) : (finalModel.tooManyRuntimeMsgs ? _Utils_Tuple2(
							_Utils_update(
								finalModel,
								{isRunning: false}),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
										_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$Warning, 'Warning: More than 100 runtime errors occurred while running at instant speed. Please debug your code (e.g., by stepping or lowering execution speed) to investigate the issue.')),
										someCmds
									]))) : (finalModel.halted ? _Utils_Tuple2(
							finalModel,
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
			...
			case 'ComputeAndPrintDuration':
				var byHalting = msg.a;
				var now = msg.b;
				var _v5 = model.simulationStartTime;
				if (_v5.$ === 'Just') {
					var startTime = _v5.a;
					var numOfInstructions = model.executedInstructions;
					var fromFloatWithDecimals = F2(
					...
					return (!numOfInstructions) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{isRunning: false, simulationStartTime: $elm$core$Maybe$Nothing}),
						$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
							_Utils_Tuple2(
								$author$project$Shared$Types$ConsoleMessage$InfoMessage,
			...
			case 'Pause':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{highlighted_input_tape: $elm$core$Dict$empty, highlighted_output_tape: $elm$core$Dict$empty, highlighted_registers: $elm$core$Dict$empty, isRunning: false}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							inputTapePointer: 0,
							instructionPointer: 0,
							instructions: A2($author$project$Ram$Utils$RamParser$parseRAM, model.inputText, model),
							isRunning: false,
							logSpace: 0,
							logTime: 0,
							outputTape: $elm$core$Array$empty,
			...
			case 'RemoveHighlightFromRegisters':
				var reg = msg.a;
				var newHighlighted = A2($elm$core$Dict$remove, reg, model.highlighted_registers);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{highlighted_registers: newHighlighted}),
					$elm$core$Platform$Cmd$none);
			case 'RemoveHighlightFromInputTape':
				var idx = msg.a;
				var newHighlighted = A2($elm$core$Dict$remove, idx, model.highlighted_input_tape);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{highlighted_input_tape: newHighlighted}),
					$elm$core$Platform$Cmd$none);
			case 'RemoveHighlightFromOutputTape':
				var idx = msg.a;
				var newHighlighted = A2($elm$core$Dict$remove, idx, model.highlighted_output_tape);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{highlighted_output_tape: newHighlighted}),
					$elm$core$Platform$Cmd$none);
			case 'SwitchHighlight':
				var _v7 = msg.a;
				...
				var dest = _v8.b;
				var style = _v8.c;
				var newHighlightedRegisters = (typeSource === 1) ? A2($elm$core$Dict$remove, source, model.highlighted_registers) : model.highlighted_registers;
				var newHighlightedOutputTape = (typeSource === 2) ? A2($elm$core$Dict$remove, source, model.highlighted_output_tape) : model.highlighted_output_tape;
				var newHighlightedInputTape = (!typeSource) ? A2($elm$core$Dict$remove, source, model.highlighted_input_tape) : model.highlighted_input_tape;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{highlighted_input_tape: finalHighlightedInputTape, highlighted_output_tape: finalHighlightedOutputTape, highlighted_registers: finalHighlightedRegisters}),
					$elm$core$Platform$Cmd$none);
			case 'AddMessageWithTime':
				var messageType = msg.a;
				var posix = msg.b;
			...
			case 'SaveSlot':
				var i = msg.a;
				var _v9 = A2($elm$core$Array$get, i, model.slots);
				if (_v9.$ === 'Just') {
					var slot = _v9.a;
					var updatedSlot = _Utils_update(
						slot,
						{inputTape: model.inputTape, inputText: model.inputText});
			...
			case 'DeleteSlot':
				var i = msg.a;
				var _v10 = A2($elm$core$Array$get, i, model.slots);
				if (_v10.$ === 'Just') {
					var slot = _v10.a;
					var updatedSlot = _Utils_update(
						slot,
						{inputTape: $elm$core$Array$empty, inputText: ''});
					var encodedSlot = $author$project$Ram$Utils$HelperFunctions$encodeSlot(updatedSlot);
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'LoadSlot':
				var i = msg.a;
				var _v11 = A2($elm$core$Array$get, i, model.slots);
				if (_v11.$ === 'Just') {
					var slot = _v11.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								inputText: slot.inputText,
								instructionPointer: 0,
								instructions: A2($author$project$Ram$Utils$RamParser$parseRAM, slot.inputText, model),
								isRunning: false,
								logSpace: 0,
								logTime: 0,
								outputTape: $elm$core$Array$empty,
								...
								[
									...
									_Utils_Tuple2(
										...
										$author$project$Ram$Utils$HelperFunctions$encodeSlot(
											{inputTape: slot.inputTape, inputText: slot.inputText, name: ''}))),
									$author$project$Ram$Utils$HelperFunctions$requestAddMessage(
									_Utils_Tuple2($author$project$Shared$Types$ConsoleMessage$InfoMessage, 'Example 1 loaded.'))
								])) : ((i === 22) ? $elm$core$Platform$Cmd$batch(
							_List_fromArray(
			...
			case 'ToggleSlotsModal':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{showSlotsModal: !model.showSlotsModal}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateInputTape':
				var idx = msg.a;
				var value = msg.b;
				var updatedTape = A3($elm$core$Array$set, idx, value, model.inputTape);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{inputTape: updatedTape}),
					$author$project$Shared$Ports$setItem(
						_Utils_Tuple2(
							'ram_current',
							$author$project$Ram$Utils$HelperFunctions$encodeSlot(
								{inputTape: updatedTape, inputText: model.inputText, name: ''}))));
			case 'AddCellToInputTape':
				var updatedTape = A2($elm$core$Array$push, 0, model.inputTape);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{inputTape: updatedTape}),
					$author$project$Shared$Ports$setItem(
						_Utils_Tuple2(
							...
							$author$project$Ram$Utils$HelperFunctions$encodeSlot(
								{inputTape: updatedTape, inputText: model.inputText, name: ''}))));
			case 'RemoveLastCell':
				var len = $elm$core$Array$length(model.inputTape);
				if (len > 0) {
					var updatedTape = A3($elm$core$Array$slice, 0, len - 1, model.inputTape);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{inputTape: updatedTape}),
			...
			case 'UpdateSlotName':
				var i = msg.a;
				var newName = msg.b;
				var _v12 = A2($elm$core$Array$get, i, model.slots);
				if (_v12.$ === 'Just') {
					var slot = _v12.a;
					var updatedSlot = _Utils_update(
						slot,
			...
			case 'ToggleGuideModal':
				return model.showGuideModal ? _Utils_Tuple2(
					_Utils_update(
						model,
						{showGuideModal: !model.showGuideModal}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
			...
			case 'ToggleSettingsModal':
				return model.showSettingsModal ? _Utils_Tuple2(
					_Utils_update(
						model,
						{showSettingsModal: !model.showSettingsModal}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					...
					A2(
						...
						$elm$core$Process$sleep(20)));
			case 'RequestMathJaxUpdate':
				return _Utils_Tuple2(
					model,
					$author$project$Shared$Ports$requestMathJaxTypeset(_Utils_Tuple0));
			case 'ChangeNumOfRegisters':
				var newNum = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
		...
		switch (msg.$) {
			...
			case 'AbacusMsg':
				...
				if (subMsg.$ === 'GoBackToMenu') {
					...
					var _v3 = A2($author$project$Am$Utils$Update$update, subMsg, model.abacusModel);
					var newAbacusModel = _v3.a;
					var cmd = _v3.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{abacusModel: newAbacusModel}),
			...
			case 'RamMsg':
				...
				if (subMsg.$ === 'GoBackToMenu') {
					...
					var _v5 = A2($author$project$Ram$Utils$Update$update, subMsg, model.ramModel);
					var newRamModel = _v5.a;
					var cmd = _v5.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{ramModel: newRamModel}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$RamMsg, cmd));
				}
			case 'UrlChanged':
				var url = msg.a;
				var newPage = function () {
					var _v7 = url.fragment;
					_v7$2:
					while (true) {
						if (_v7.$ === 'Just') {
							switch (_v7.a) {
				...
				var cmdToLoad = (_Utils_eq(newPage, $author$project$Main$AbacusPage) || _Utils_eq(newPage, $author$project$Main$RamPage)) ? $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2(
							$elm$core$Task$perform,
			...
			case 'GotItem':
				...
				if (A2($elm$core$String$startsWith, 'am_', key)) {
					...
					if (decodedSlot.$ === 'Just') {
						...
						if (key === 'am_current') {
							var instructions = A2($author$project$Am$Utils$AbacusParser$parseAM, slot.inputText, model.abacusModel);
							var innerAbacusModel = model.abacusModel;
							var updatedAbacusModel = _Utils_update(
								innerAbacusModel,
								{inputText: slot.inputText, instructions: instructions});
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{abacusModel: updatedAbacusModel}),
								$elm$core$Platform$Cmd$none);
						} else {
							...
							if (maybeSlotIndex.$ === 'Just') {
								...
								var _v12 = A2($elm$core$Array$get, i, model.abacusModel.slots);
								if (_v12.$ === 'Just') {
									var updatingThisSlot = _v12.a;
									var updatedSlot = _Utils_update(
										updatingThisSlot,
										{inputText: slot.inputText, name: slot.name});
									var innerAbacusModel = model.abacusModel;
									var updatedAbacusModel = _Utils_update(
										innerAbacusModel,
										{
											slots: A3($elm$core$Array$set, i, updatedSlot, model.abacusModel.slots)
										});
									return _Utils_Tuple2(
										_Utils_update(
											model,
					...
					if (A2($elm$core$String$startsWith, 'ram_', key)) {
						...
						if (decodedSlot.$ === 'Just') {
							var slot = decodedSlot.a;
							if (key === 'ram_current') {
								var instructions = A2($author$project$Ram$Utils$RamParser$parseRAM, slot.inputText, model.ramModel);
								var innerRamModel = model.ramModel;
								var updatedRamModel = _Utils_update(
									innerRamModel,
									{inputTape: slot.inputTape, inputText: slot.inputText, instructions: instructions});
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{ramModel: updatedRamModel}),
									$elm$core$Platform$Cmd$none);
							} else {
								...
								if (maybeSlotIndex.$ === 'Just') {
									var i = maybeSlotIndex.a;
									var _v16 = A2($elm$core$Array$get, i, model.ramModel.slots);
									if (_v16.$ === 'Just') {
										var updatingThisSlot = _v16.a;
										var updatedSlots = _Utils_update(
											updatingThisSlot,
											{inputTape: slot.inputTape, inputText: slot.inputText, name: slot.name});
										var innerRamModel = model.ramModel;
										var updatedRamModel = _Utils_update(
											innerRamModel,
											{
												slots: A3($elm$core$Array$set, i, updatedSlots, model.ramModel.slots)
											});
										return _Utils_Tuple2(
											_Utils_update(
												model,
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aboutModalOpen: !model.aboutModalOpen}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$ToggleAboutModal = {$: 'ToggleAboutModal'};
...
var $author$project$Am$Types$Messages$ChangeMaxExecutedInstructions = function (a) {
	return {$: 'ChangeMaxExecutedInstructions', a: a};
};
var $author$project$Am$Types$Messages$ChangeNumOfRegisters = function (a) {
	return {$: 'ChangeNumOfRegisters', a: a};
};
var $author$project$Am$Types$Messages$ChangeSpeed = function (a) {
	return {$: 'ChangeSpeed', a: a};
};
var $author$project$Am$Types$Messages$DeleteInput = {$: 'DeleteInput'};
var $author$project$Am$Types$Messages$DeleteSlot = function (a) {
	return {$: 'DeleteSlot', a: a};
};
var $author$project$Am$Types$Messages$GoBackToMenu = {$: 'GoBackToMenu'};
var $author$project$Am$Types$Messages$LoadSlot = function (a) {
	return {$: 'LoadSlot', a: a};
};
var $author$project$Am$Types$Messages$NoOp = {$: 'NoOp'};
var $author$project$Am$Types$Messages$Pause = {$: 'Pause'};
var $author$project$Am$Types$Messages$Reset = {$: 'Reset'};
var $author$project$Am$Types$Messages$SaveSlot = function (a) {
	return {$: 'SaveSlot', a: a};
};
var $author$project$Am$Types$Messages$Start = {$: 'Start'};
var $author$project$Am$Types$Messages$Step = {$: 'Step'};
var $author$project$Am$Types$Messages$ToggleGuideModal = {$: 'ToggleGuideModal'};
var $author$project$Am$Types$Messages$ToggleSettingsModal = {$: 'ToggleSettingsModal'};
var $author$project$Am$Types$Messages$ToggleSlotsModal = {$: 'ToggleSlotsModal'};
var $author$project$Am$Types$Messages$TypedMaxExecutedInstructions = function (a) {
	return {$: 'TypedMaxExecutedInstructions', a: a};
};
var $author$project$Am$Types$Messages$TypedRegsNum = function (a) {
	return {$: 'TypedRegsNum', a: a};
};
					...
					case 'InfoMessage':
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									'[' + ($author$project$Shared$Components$Console$formatTime(msg.timestamp) + ('] ' + msg.text)))
								]));
					case 'ErrorMessage':
						return A2(
							$elm$html$Html$div,
	...
	return {
		body: _List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								(model.speedIdx === 7) && (_Utils_cmp(model.executedInstructions, model.totalMaxExecutedInstructions) > -1)),
								A3($author$project$Shared$Components$SpeedSlider$speedSlider, model.speedIdx, model.speeds, $author$project$Am$Types$Messages$ChangeSpeed),
								A5($author$project$Shared$Components$MenuButtons$menuButtons, $author$project$Am$Types$Messages$ToggleSlotsModal, $author$project$Am$Types$Messages$GoBackToMenu, $author$project$Am$Types$Messages$ToggleGuideModal, $author$project$Am$Types$Messages$ToggleSettingsModal, model.simStarted)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A4($author$project$Shared$Components$InputTextArea$inputTextArea, model.simStarted, model.inputText, $author$project$Am$Types$Messages$UpdateCode, $author$project$Am$Types$Messages$DeleteInput),
								A3($author$project$Am$Components$Instructions$viewInstructions, model.instructions, model.instructionPointer, model.simStarted),
								A2($author$project$Am$Components$Registers$viewRegisters, model.registers, model.highlighted)
							])),
						$author$project$Shared$Components$Console$viewConsole(model.consoleMessages),
						model.showSlotsModal ? A8(
						$author$project$Shared$Components$SlotsModal$viewSlotsModal,
						model.inputText === '',
						A2(
							$elm$core$Array$map,
							function (slot) {
								return _Utils_Tuple2(slot.name, slot.inputText === '');
							},
							model.slots),
				...
				model.showGuideModal ? A3($author$project$Am$Components$GuideModal$viewGuideModal, $author$project$Am$Types$Messages$ToggleGuideModal, $author$project$Am$Types$Messages$LoadSlot, $author$project$Am$Types$Messages$NoOp) : $elm$html$Html$text(''),
				model.showSettingsModal ? $author$project$Am$Components$SettingsModal$viewSettingsModal(model.totalNumberOfRegisters)(model.totalMaxExecutedInstructions)($author$project$Am$Types$Messages$ToggleSettingsModal)($author$project$Am$Types$Messages$ChangeNumOfRegisters)($author$project$Am$Types$Messages$ChangeMaxExecutedInstructions)($author$project$Am$Types$Messages$TypedRegsNum)($author$project$Am$Types$Messages$TypedMaxExecutedInstructions)(model.typedTotalNumberOfRegisters)(model.typedTotalMaxExecutedInstructions)($author$project$Am$Types$Messages$NoOp) : $elm$html$Html$text('')
			]),
		title: 'HnatkoSim | AM'
	};
};
...
var $author$project$Ram$Types$Messages$DeleteInput = {$: 'DeleteInput'};
var $author$project$Ram$Types$Messages$DeleteSlot = function (a) {
	return {$: 'DeleteSlot', a: a};
};
var $author$project$Ram$Types$Messages$GoBackToMenu = {$: 'GoBackToMenu'};
var $author$project$Ram$Types$Messages$LoadSlot = function (a) {
	return {$: 'LoadSlot', a: a};
};
var $author$project$Ram$Types$Messages$NoOp = {$: 'NoOp'};
var $author$project$Ram$Types$Messages$Pause = {$: 'Pause'};
var $author$project$Ram$Types$Messages$Reset = {$: 'Reset'};
var $author$project$Ram$Types$Messages$SaveSlot = function (a) {
	return {$: 'SaveSlot', a: a};
};
var $author$project$Ram$Types$Messages$Start = {$: 'Start'};
var $author$project$Ram$Types$Messages$Step = {$: 'Step'};
var $author$project$Ram$Types$Messages$ToggleGuideModal = {$: 'ToggleGuideModal'};
var $author$project$Ram$Types$Messages$ToggleSettingsModal = {$: 'ToggleSettingsModal'};
var $author$project$Ram$Types$Messages$ToggleSlotsModal = {$: 'ToggleSlotsModal'};
...
var $author$project$Ram$Types$Messages$AddCellToInputTape = {$: 'AddCellToInputTape'};
...
var $author$project$Ram$Types$Messages$RemoveLastCell = {$: 'RemoveLastCell'};
var $author$project$Ram$Types$Messages$UpdateInputTape = F2(
	function (a, b) {
		return {$: 'UpdateInputTape', a: a, b: b};
	});
...
var $author$project$Ram$Components$InputTape$renderInputCell = F3(
	function (index, cell, model) {
		var isDisabled = model.simStarted ? _List_fromArray(
			[
				$elm$html$Html$Attributes$disabled(true)
			]) : _List_Nil;
		var highlightClass = A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Dict$get, index, model.highlighted_input_tape));
		...
		var _v0 = _Utils_Tuple2(
			...
			(highlightClass !== '') ? (highlightClass + ' cursor-not-allowed text-gray-700') : (model.simStarted ? 'cursor-not-allowed text-gray-700' : 'bg-white'));
		...
		return (_Utils_eq(
			index,
			$elm$core$Array$length(model.inputTape) - 1) && (!model.simStarted)) ? A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Ram$Components$InputTape$viewInputTape = function (model) {
	var cellsList = $elm$core$Array$toList(model.inputTape);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Ram$Components$OutputTape$viewOutputTape = function (model) {
	var cells = $elm$core$Array$toList(model.outputTape);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
						...
						A2(
							...
							function (_v0) {
								...
								var highlightClass = A2(
									$elm$core$Maybe$withDefault,
									'',
									A2($elm$core$Dict$get, regNum, model.highlighted_registers));
								return A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
							...
							$elm$core$Dict$toList(model.registers)))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$fromInt(model.logTime))
											]))
									])),
								A2(
								$elm$html$Html$p,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$fromInt(model.executedInstructions))
											]))
									]))
							])),
						A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$fromInt(model.logSpace))
											]))
									])),
								A2(
								$elm$html$Html$p,
													...
													$elm$core$List$length(
														A2(
															...
															A2(
																...
																$elm$core$Dict$values(model.registers))))))
											]))
									]))
							]))
					]))
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														'current: ' + $elm$core$String$fromInt(model.totalNumberOfRegisters))
													]))
											]))
									])),
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$min('10'),
												$elm$html$Html$Attributes$max('10000'),
												$elm$html$Html$Attributes$value(model.typedTotalNumberOfRegisters),
										...
										var parsed = A2(
											$elm$core$Maybe$withDefault,
											0,
											$elm$core$String$toInt(model.typedTotalNumberOfRegisters));
										var isValid = (parsed >= 10) && (parsed <= 10000);
										return A2(
											$elm$html$Html$button,
											_List_fromArray(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														'current: ' + $elm$core$String$fromInt(model.totalMaxExecutedInstructions))
													]))
											]))
									])),
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$max('100000000'),
												$elm$html$Html$Attributes$value(model.typedTotalMaxExecutedInstructions),
										...
										var parsed = A2(
											$elm$core$Maybe$withDefault,
											0,
											$elm$core$String$toInt(model.typedTotalMaxExecutedInstructions));
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														'current: ' + $elm$core$String$fromInt(model.logBase))
													]))
											]))
									])),
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$value(model.typedBase),
										...
										var parsed = A2(
											$elm$core$Maybe$withDefault,
											0,
											$elm$core$String$toInt(model.typedBase));
					...
					[
						...
						_List_fromArray(
							[
								...
								(model.speedIdx === 7) && ((_Utils_cmp(model.executedInstructions, model.totalMaxExecutedInstructions) > -1) || model.tooManyRuntimeMsgs)),
								A3($author$project$Shared$Components$SpeedSlider$speedSlider, model.speedIdx, model.speeds, $author$project$Ram$Types$Messages$ChangeSpeed),
								A5($author$project$Shared$Components$MenuButtons$menuButtons, $author$project$Ram$Types$Messages$ToggleSlotsModal, $author$project$Ram$Types$Messages$GoBackToMenu, $author$project$Ram$Types$Messages$ToggleGuideModal, $author$project$Ram$Types$Messages$ToggleSettingsModal, model.simStarted)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A4($author$project$Shared$Components$InputTextArea$inputTextArea, model.simStarted, model.inputText, $author$project$Ram$Types$Messages$UpdateCode, $author$project$Ram$Types$Messages$DeleteInput),
										A4($author$project$Ram$Components$Instructions$viewInstructions, model.instructions, model.instructionPointer, model.simStarted, model.halted),
						...
						model.showGuideModal ? A3($author$project$Ram$Components$GuideModal$viewGuideModal, $author$project$Ram$Types$Messages$ToggleGuideModal, $author$project$Ram$Types$Messages$LoadSlot, $author$project$Ram$Types$Messages$NoOp) : $elm$html$Html$text(''),
						model.showSettingsModal ? $author$project$Ram$Components$SettingsModal$viewSettingsModal(model) : $elm$html$Html$text('')
					]))
			]),
		title: 'HnatkoSim | RAM'
	};
	...
	switch (_v0.$) {
			...
			return {
				body: _List_fromArray(
					[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Events$onClick(
														$author$project$Main$ChangePage($author$project$Main$AbacusPage)),
												...
												_List_fromArray(
													[
														$elm$html$Html$Events$onClick(
														$author$project$Main$ChangePage($author$project$Main$RamPage)),
														$elm$html$Html$Attributes$class('px-2 sm:px-8 py-4 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded shadow-lg transition-colors duration-200')
													]),
												_List_fromArray(
													[
						...
						model.aboutModalOpen ? $author$project$Main$viewAboutModal : $elm$html$Html$text('')
					]),
		...
		case 'AbacusPage':
			return A2(
				...
				$author$project$Main$AbacusMsg,
				$author$project$Am$View$view(model.abacusModel));
		default:
			return A2(
				$author$project$Main$documentMap,
				$author$project$Main$RamMsg,
				$author$project$Ram$View$view(model.ramModel));
	}
};
